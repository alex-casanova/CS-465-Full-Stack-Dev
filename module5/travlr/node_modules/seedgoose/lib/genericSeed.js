...
const genericSeed = function (collectionName, records, mongoose, reporter, command) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield series_async_each_1.default(records, (record, index) => __awaiter(this, void 0, void 0, function* () {
            ...
            const nativeId = new mongoose.Types.ObjectId(stringIsObjectId_1.default(record._id) ? record._id : yield idMap_1.getUniqId(collectionName, record._id));
            ...
            if (command === SeedingCommand_1.SeedingCommandType.SEED) {
                ...
                if (exist) {
                    ...
                    const insertResult = (yield dbCollection.insertOne(Object.assign({ _id: nativeId }, transformedRecord))).insertedId;
